...
if result.id_ == tonumber(1843759714) then
...
if userid == tonumber(1843759714) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1843759714) then
...
function Function_BLACKBOTSS(extra, result, success)
if result.sender_user_id_ == tonumber(1843759714) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1843759714) then
...
os.execute('wget https://raw.githubusercontent.com/blackedSaqr/OFFICIAL/main/BLACKBOTSS.lua')
os.execute('wget https://raw.githubusercontent.com/blackedSaqr/OFFICIAL/main/start.lua')
